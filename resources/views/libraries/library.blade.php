    ...
    <div class="md:flex justify-center mt-10 md:gap-4 md:items-center ">
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('library.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                ...
                <input type="submit" value="Añadir bilbioteca" class="bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-r hover:from-cyan-600 hover:to-blue-600 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg">
