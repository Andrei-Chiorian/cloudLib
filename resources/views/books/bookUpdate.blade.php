        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('book.update') }}" method="POST" enctype="multipart/form-data" novalidate>
                ...
                <div class="mb-5 ">
                    ...
                    <textarea id="synopsis" name="synopsis" placeholder="Introduce la sinopsis" class="border p-3 w-full rounded-lg @error('name') border-red-500 @enderror">{{$book->synopsis}}</textarea>                    
                    @error('synopsis')
                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                    @enderror
                </div>
