...
@auth
    <div class="flex gap-5">
        <div class="w-3/4 overflow-y-scroll scrollbar-hide max-h-screen min-h-screen">
            <div class="text-center font-bold text-2xl">
                Bibliotecas de {{auth()->user()->username}}
            </div>
            
            <div class="grid mt-16">                         
                <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 items-center">                    
        ...
        <div class="overflow-auto scrollbar-hide w-1/4 text-center p-1 text-lg font-medium text-gray-600">
