        ...
        <div class="md:w-4/12">
            <div class=" bg-white p-6 rounded-lg shadow-xl">
                <form action="{{ route('register') }}" method="POST" novalidate>
                    ...
                    <div class="mb-5">
                        <label for="surname" class="mb-2 block uppercase text-gray-500 font-bold">Apellido</label>
                        <input type="text" id="surname" name="surname" placeholder="Introduce tu apellido" value="{{old('surname')}}" class="border p-3 w-full rounded-lg @error('surname') border-red-500 @enderror"/>
                        @error('surname')
                            <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-5 ">
                        ...
                        <textarea id="presentacion" name="presentacion" placeholder="Añade una presentacion para que el resto los usuarios sepan mas acerca de ti" class="overflow-auto scrollbar-hide border p-3 w-full rounded-lg @error('name') border-red-500 @enderror">{{old('presentacion')}}</textarea>                    
                        @error('presentacion')
                            <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                        @enderror
                    </div>
